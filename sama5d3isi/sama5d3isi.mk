...
$(call inherit-product, device/atmel/sama5d3isi/device.mk)

PRODUCT_NAME := sama5d3isi
PRODUCT_DEVICE := sama5d3isi
PRODUCT_BRAND := Android
PRODUCT_MODEL := Android for Atmel A5

# S/W button enabled in resource
DEVICE_PACKAGE_OVERLAYS := device/atmel/sama5d3isi/overlay
